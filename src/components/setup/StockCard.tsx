...
export const StockCard = ({ ticker, name, category, isSelected, onToggle} : StockCardProps) => {
    ...
    >
      <div className="flex flex-col gap-1">
        <div className="flex items-center gap-2">
          ...
          <p className="h-5 px-2 leading-5 rounded bg-gray-100 text-xs text-gray-600">{category}</p>
        </div>
