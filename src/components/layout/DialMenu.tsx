...
const ITEMS = [
  ...
  { icon: Home,  label: 'HOME', path: '/',     angle: -50,  color: '#0064FF' },
  { icon: Heart, label: '관심', path: '/like', angle: -90,  color: '#EF4444' },
];
      ...
      <AnimatePresence>
        {open && (
          <div
            ...
            style={{ left: menuPos.x, top: menuPos.y, transform: 'translateX(-50%, -50%)' }}
          >
            {/* 롱프레스 힌트 링 */}
            <motion.div
