      ...
      <div className="px-4 py-6 pb-16 flex flex-col gap-8 text-gray-700">
        ...
        <section className="flex flex-col gap-2">
          ...
          <ul className="text-sm leading-relaxed flex flex-col gap-2 pl-2">
            <li>1.	“서비스”란 회사가 제공하는 금융·증권 관련 뉴스 정보 제공, AI 기반 요약·분석, 행동 기반 개인화 큐레이션, 스낵컬처 퀴즈 등 일체의 기능을 의미합니다.</li>
            ...
            <li>4.	“회원”이란 구글(Google) 계정을 통한 소셜 로그인(OAuth) 인증으로 서비스에 가입하여 이를 이용하는 자를 말합니다.</li>
            <li>5.	“콘텐츠”란 회사가 제공하는 뉴스 요약, AI 근거 분석, 감성 점수, 기술적 지표 시각화, 스낵컬처 퀴즈 등 일체의 정보·자료를 말합니다.</li>
        ...
        <section className="flex flex-col gap-2">
          ...
          <ul className="text-sm leading-relaxed flex flex-col gap-2 pl-2">
            <li>1. 이용자는 구글(Google) 계정을 통한 소셜 로그인 방식으로만 서비스에 가입하며, 별도의 이메일 회원가입 및 비밀번호 설정 절차를 두지 않습니다. 이용자가 최초 로그인 시 본 약관 및 개인정보처리방침에 동의함으로써 회원가입이 완료됩니다.</li>
            <li>2. 회사는 다음 각 호에 해당하는 신청에 대하여는 가입을 승낙하지 않거나 사후에 이용계약을 해지할 수 있습니다.
              <ul className="flex flex-col gap-1 pl-4 mt-1">
                ...
                <li>◦	타인의 구글 계정 명의를 도용한 경우</li>
                <li>◦	구글 인증 과정에서 부정한 방법이 확인된 경우</li>
        ...
        <section className="flex flex-col gap-2">
          ...
          <ul className="text-sm leading-relaxed flex flex-col gap-2 pl-2">
            <li>1. 회원은 자신의 구글 계정 정보(이메일 등)가 변경된 경우 이를 확인·관리해야 하며, 미확인으로 인한 불이익은 회원이 부담합니다.</li>
            <li>2. 회원 계정에 대한 접근 및 보안 관리 책임은 회원 본인(구글 계정 명의인)에게 있으며, 제3자가 회원의 구글 계정을 통해 본 서비스에 접근하도록 하여서는 안 됩니다.</li>
            <li>3. 회원은 자신의 구글 계정이 도용되거나 제3자에 의해 무단으로 사용되고 있음을 인지한 경우 즉시 회사에 통지하고 회사의 안내에 따라야 합니다.</li>
          </ul>
        </section>
          ...
          <ul className="text-sm leading-relaxed flex flex-col gap-2 pl-2">
            <li>1. 회사는 회원에게 다음 각 호의 서비스를 제공합니다.
              <ul className="flex flex-col gap-1 pl-4 mt-1">
                ...
                <li>◦ 행동 학습 기반 개인화 뉴스 추천(백그라운드 AI 큐레이션)</li>
                <li>◦ 스와이프 피드 내 삽입되는 스낵컬처 퀴즈 콘텐츠(재미·리텐션 목적)</li>
                <li>◦기타 회사가 추가 개발하거나 다른 회사와의 제휴 등을 통해 제공하는 일체의 서비스</li>
              </ul>
            </li>
            <li>2. 서비스는 연중무휴, 1일 24시간 제공함을 원칙으로 합니다. 다만 회사는 서비스의 종류나 성질에 따라 별도로 이용시간을 정할 수 있으며, 이 경우 사전에 그 내용을 공지합니다. 본 서비스는 베타테스트 단계이므로 서비스의 안정성·연속성·가용성이 보장되지 않으며, 점검·개선을 위하여 사전 공지 없이 수시로 중단·변경될 수 있습니다.</li>
          </ul>
        </section>
        ...
        <section className="flex flex-col gap-2">
          ...
          <ul className="text-sm leading-relaxed flex flex-col gap-2 pl-2">            
            ...
            <li>3. 본 서비스가 제공하는 모든 콘텐츠(AI 요약, 감성 점수 및 근거 분석, 기술적 지표 해석 등)는 참고용 정보로서, 정확성·완전성·시의성·적시성을 보장하지 않습니다. 감성 점수는 해당 기사 텍스트의 어조를 분석한 결과일 뿐, 종목의 상승·하락을 예측하거나 매수·매도를 권유하는 지표가 아닙니다.</li>
        ...
        <section className="flex flex-col gap-2">
          ...
          <ul className="text-sm leading-relaxed flex flex-col gap-2 pl-2">
            <li>1. 본 서비스는 인공지능(AI) 모델을 활용하여 뉴스 요약, 감성 점수, AI 근거 분석 등 콘텐츠를 자동으로 생성합니다.</li>
            ...
            <li>3. 이용자는 AI 생성 콘텐츠를 투자 판단의 유일한 근거로 사용해서는 안 되며, 반드시 원문 뉴스, 공식 공시, 전문가 의견 등을 직접 확인해야 합니다.</li>
            <li>4. AI가 생성한 콘텐츠(요약, 감성 점수, 근거 분석 등)의 부정확성, 오류, 누락으로 인한 이용자의 손해에 대해 회사는 고의 또는 중과실이 없는 한 책임을 부담하지 않습니다.</li>
          </ul>
        </section>
        ...
        <section className="flex flex-col gap-2">
          ...
          <ul className="text-sm leading-relaxed flex flex-col gap-2 pl-2">
            <li>1. 회사는 다음 각 호의 사유로 인하여 발생한 손해에 대해서는 책임을 지지 않습니다.
              <ul className="flex flex-col gap-1 pl-4 mt-1">
                <li>◦ 천재지변, 전쟁, 기간통신사업자의 서비스 중단, 제3자 서비스 제공사(AI 모델, 뉴스 데이터 제공사 등)의 장애 등 불가항력으로 인한 서비스 중단</li>
        ...
        <section className="flex flex-col gap-2">
          ...
          <ul className="text-sm leading-relaxed flex flex-col gap-2 pl-2">
            ...
            <li>5. 서비스 내 입력 기능(퀴즈 응답, 문의·피드백 등)을 이용하여 회사 또는 제3자의 명예를 훼손하거나, 위법·유해한 정보(허위 정보, 시세조종성 정보, 미공개 중요정보 등)를 생성·유포하는 행위</li>
            <li>6. 서비스 내 입력 기능에 주민등록번호·계좌번호·비밀번호 등 민감정보를 입력하는 행위</li>
        ...
        <section className="flex flex-col gap-2">
          ...
          <ul className="text-sm leading-relaxed flex flex-col gap-2 pl-2">
            ...
            <li>4. 이용자가 본 서비스를 이용함으로써 작성·등록한 게시물(예: 퀴즈 응답, 문의·피드백 등)의 저작권은 이용자에게 귀속되나, 회사는 이를 서비스 운영·개선·홍보 목적으로 무상으로 사용할 수 있습니다.</li>
          </ul>
        </section>
        ...
        <section className="flex flex-col gap-2">
          ...
          <ul className="text-sm leading-relaxed flex flex-col gap-2 pl-2">
            <li>1. 회원은 언제든지 앱 내 설정(우상단 햄버거 메뉴)을 통해 회원 탈퇴를 신청할 수 있으며, 회사는 지체 없이 이를 처리합니다.</li>
